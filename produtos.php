                ...
                <div class="info-card rounded-4 p-4">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="text-white-50 mb-0">A CSR1 aparece como solução principal para soldagem robotizada, alinhada ao posicionamento público da empresa. citeturn775859search0turn775859search3turn775859search11</p>
                        </div>
